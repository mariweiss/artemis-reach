  ...
  return (
    <div style={{ fontFamily: "sans-serif", backgroundColor: cores.fundo }}>
        ...
        >
          {minhaPos && (
            <AdvancedMarker position={minhaPos}>
              <div style={{ width: "36px", height: "36px", borderRadius: "50%", backgroundColor: cores.roxoEscuro, display: "flex", alignItems: "center", justifyContent: "center", border: "3px solid white", boxShadow: "0 2px 8px rgba(0,0,0,0.2)" }}>
          ...
          {localizacoes.map((loc) => (
            <AdvancedMarker key={loc.id} position={{ lat: loc.latitude, lng: loc.longitude }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "4px" }}>
                <div style={{ width: "36px", height: "36px", borderRadius: "50%", backgroundColor: loc.corGrupo, display: "flex", alignItems: "center", justifyContent: "center", border: "3px solid white", boxShadow: "0 2px 8px rgba(0,0,0,0.15)" }}>
      ...
      <div style={{ position: "fixed", bottom: "90px", left: "24px" }}>
        <button onClick={() => minhaPos && setMinhaPos({ ...minhaPos })} style={{ width: "44px", height: "44px", borderRadius: "50%", backgroundColor: cores.branco, border: "none", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", boxShadow: "0 2px 12px rgba(0,0,0,0.15)" }}>
      ...
      <div style={{ position: "fixed", bottom: "148px", right: "24px" }}>
        <button onClick={() => setModalGrupos(true)} style={{ width: "44px", height: "44px", borderRadius: "50%", backgroundColor: cores.branco, border: "none", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", boxShadow: "0 2px 12px rgba(0,0,0,0.15)", position: "relative" }}>
          <Layers size={20} color={cores.roxo} />
          {gruposSelecionados.size > 0 && (
            <div style={{ position: "absolute", top: "-4px", right: "-4px", width: "18px", height: "18px", borderRadius: "50%", backgroundColor: cores.roxo, color: "white", fontSize: "10px", fontWeight: "700", display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{ position: "fixed", bottom: "90px", right: "24px" }}>
        <button onClick={() => window.location.href = "/inicio"} style={{ width: "56px", height: "56px", borderRadius: "50%", backgroundColor: "#ef4444", border: "4px solid white", display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", boxShadow: "0 4px 20px rgba(239,68,68,0.3)" }}>
      ...
      {modalGrupos && (
        <>
          ...
          <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, backgroundColor: cores.branco, borderRadius: "24px 24px 0 0", padding: "24px", zIndex: 300, boxShadow: "0 -4px 24px rgba(90,73,151,0.15)" }}>
            ...
            {grupos.length > 1 && (
              <button onClick={toggleTodos} style={{ width: "100%", padding: "12px 16px", borderRadius: "12px", backgroundColor: cores.fundo, border: "none", display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "pointer", marginBottom: "12px" }}>
                ...
                <div style={{ width: "20px", height: "20px", borderRadius: "6px", backgroundColor: gruposSelecionados.size === grupos.length ? cores.roxo : "transparent", border: `2px solid ${gruposSelecionados.size === grupos.length ? cores.roxo : "#ddd"}`, display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            {grupos.length === 0 ? (
              <div style={{ textAlign: "center", padding: "24px 0" }}>
                <p style={{ color: cores.lavanda, fontSize: "14px" }}>Nenhum grupo criado ainda.</p>
                <p style={{ color: "#bbb", fontSize: "12px" }}>Crie grupos na aba Círculo.</p>
              </div>
            ) : grupos.map((grupo) => {
              const ativo = gruposSelecionados.has(grupo.id)
              return (
                <button key={grupo.id} onClick={() => toggleGrupo(grupo.id)} style={{ width: "100%", padding: "14px 16px", borderRadius: "14px", border: `1.5px solid ${ativo ? grupo.cor : "rgba(90,73,151,0.1)"}`, backgroundColor: ativo ? `${grupo.cor}12` : cores.branco, display: "flex", alignItems: "center", gap: "12px", cursor: "pointer", marginBottom: "8px" }}>
                  ...
                  <div style={{ flex: 1, textAlign: "left" }}>
                    ...
                    <p style={{ margin: 0, fontSize: "12px", color: cores.lavanda }}>{(grupo.membros?.length || 1) - 1} membros além de você</p>
                  </div>
                  <div style={{ width: "22px", height: "22px", borderRadius: "6px", backgroundColor: ativo ? grupo.cor : "transparent", border: `2px solid ${ativo ? grupo.cor : "#ddd"}`, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
            ...
            <button onClick={() => setModalGrupos(false)} style={{ width: "100%", marginTop: "8px", padding: "14px", backgroundColor: cores.roxo, color: "white", border: "none", borderRadius: "14px", fontSize: "14px", fontWeight: "600", cursor: "pointer" }}>
              Ver no mapa
            </button>
          </div>
        </>
